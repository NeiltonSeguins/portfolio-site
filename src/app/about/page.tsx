...
const aboutData = {
  name: "Neilton",
  description: [
    "Sou de São Luís, MA, formado em Bacharelado em Ciência e Tecnologia e em Engenharia Mecânica pela UFMA. Em 2021, decidi mudar de área e comecei minha jornada na programação, combinando minha curiosidade técnica com a paixão por aprender.",
